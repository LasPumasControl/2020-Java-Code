// the WoF class is used to control the wheel of fortune through
// use of the color sensor
...
public class WoF {
	...
	public WoF(VictorSP WoF, ColorMatch m_colorMatcher, ColorSensorV3 m_colorSensor, double defaultWoF) {
        this.WoF = WoF;
